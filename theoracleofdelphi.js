...
define([
    ...
    "ebg/core/gamegui",
    "ebg/counter",
    g_gamethemeurl + "modules/js/HexGrid.js?v440",
    g_gamethemeurl + "modules/js/Components.js?v440",
    g_gamethemeurl + "modules/js/ClusterDefinitions.js?v440",
    g_gamethemeurl + "modules/js/BoardBuilder.js?v440",
    g_gamethemeurl + "modules/js/BoardRenderer.js?v440",
    g_gamethemeurl + "modules/js/LogGlyphs.js?v440",
    g_gamethemeurl + "modules/js/LogTokens.js?v440",
    g_gamethemeurl + "modules/js/DeliveryRelations.js?v440",
    g_gamethemeurl + "modules/BX/js/DragScroller.js?v440",
],
function (dojo, declare, gamegui, counter, HexGrid, Components, ClusterDefinitions, BoardBuilder, BoardRenderer, LogGlyphs, LogTokens, DeliveryRelations) {
    ...
    return declare("bgagame.theoracleofdelphi", ebg.core.gamegui, {
        ...
        // Keep in sync with the ?v440 markers in the define() block above.
        JS_VERSION: "v440",
