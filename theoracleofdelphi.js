...
define([
    ...
    "ebg/core/gamegui",
    "ebg/counter",
    g_gamethemeurl + "modules/js/HexGrid.js?v341",
    g_gamethemeurl + "modules/js/Components.js?v341",
    g_gamethemeurl + "modules/js/ClusterDefinitions.js?v341",
    g_gamethemeurl + "modules/js/BoardBuilder.js?v341",
    g_gamethemeurl + "modules/js/BoardRenderer.js?v341",
    g_gamethemeurl + "modules/js/LogGlyphs.js?v341",
    g_gamethemeurl + "modules/js/LogTokens.js?v341",
    g_gamethemeurl + "modules/BX/js/DragScroller.js?v341",
],
function (dojo, declare, gamegui, counter, HexGrid, Components, ClusterDefinitions, BoardBuilder, BoardRenderer, LogGlyphs, LogTokens) {
    ...
    return declare("bgagame.theoracleofdelphi", ebg.core.gamegui, {
        ...
        // Keep in sync with the ?v341 markers in the define() block above.
        JS_VERSION: "v341",
