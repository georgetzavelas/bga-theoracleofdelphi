...
define([
    ...
    "ebg/core/gamegui",
    "ebg/counter",
    g_gamethemeurl + "modules/js/HexGrid.js?v342",
    g_gamethemeurl + "modules/js/Components.js?v342",
    g_gamethemeurl + "modules/js/ClusterDefinitions.js?v342",
    g_gamethemeurl + "modules/js/BoardBuilder.js?v342",
    g_gamethemeurl + "modules/js/BoardRenderer.js?v342",
    g_gamethemeurl + "modules/js/LogGlyphs.js?v342",
    g_gamethemeurl + "modules/js/LogTokens.js?v342",
    g_gamethemeurl + "modules/BX/js/DragScroller.js?v342",
],
function (dojo, declare, gamegui, counter, HexGrid, Components, ClusterDefinitions, BoardBuilder, BoardRenderer, LogGlyphs, LogTokens) {
    ...
    return declare("bgagame.theoracleofdelphi", ebg.core.gamegui, {
        ...
        // Keep in sync with the ?v342 markers in the define() block above.
        JS_VERSION: "v342",
