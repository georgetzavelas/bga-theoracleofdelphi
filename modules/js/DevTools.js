...
define([
    ...
    return declare("delphi.DevTools", null, {
        ...
        testRollOracleDice: function() {
            ...
            this.game.components.animateDiceRoll(1, newColors);
        },
        ...
        testRollBattleDie: function() {
            ...
            this.game.components.rollBattleDie(result);
        },
        ...
        testShowShipRange: function() {
            ...
            var pos = this.game.shipPositions && this.game.shipPositions[1];
            if (pos) {
                this.game.components.selectShip(1);
                this.game.showShipRange(1, pos.q, pos.r);
            } else {
        ...
        testResetShipsToZeus: function() {
            ...
            colors.forEach(function(color, index) {
                ...
                game.components.moveShip(playerId, center.x + offset.dx, center.y + offset.dy, true);
                game.shipPositions[playerId] = { q: zeus.q, r: zeus.r };
            });

            game.clearRangeOverlays();
            game.components.deselectShips();
        },
        ...
        testFlipAllShrines: function() {
            this.game.components.shrines.forEach(function(el, id) {
        ...
        testRegenerateBoard: function() {
            ...
            game.components.ships.clear();
            game.components.monsters.clear();
            game.components.shrines.clear();
            game.shipPositions = {};
            game.currentShipRange = null;
